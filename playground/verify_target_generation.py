...
Usage:
    python playground/verify_target_generation.py

The script will:
- Load both crudo and target files
- Compare structure (columns, rows)
- Verify clase_ternaria values and distribution
- Sample 10 random clients and compare all their data
- Report any discrepancies

Exit codes:
    0: Verification passed - files are identical except for clase_ternaria
    1: Verification failed - found discrepancies
"""

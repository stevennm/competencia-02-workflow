...
def main():
    ...
    print("  4. Advanced Features (volatility, momentum, interactions)")
    print("  5. Random Forest Features (optional)")
    ...
    steps = [
        ...
        "04_advanced_features.py",  # New step
        "05_rf_features.py"
    ]
    ...
    print("  - data/advanced_featured_data.parquet (with advanced features)")
